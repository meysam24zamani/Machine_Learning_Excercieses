...
## We will see in class that there are at least two ways of
## characterizing this trade-off: Vapnik's theorems (using
## VC-dimension) and Bias/Variance analysis (due to Geman & Geman)
...
## Inspect the results. Which degree yields the lowest error on validation data? There is a close difference between degrees 3 and 4; that for degree 3 should be a bit smaller, but not always
