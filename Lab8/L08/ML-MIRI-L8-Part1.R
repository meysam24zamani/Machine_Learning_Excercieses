...
# LAB 8: Multilayer Perceptrons (Part 1)
...
##################################################################
## Multilayer Perceptron Example 1: Admission into graduate school
##################################################################
...
## To have a baseline reference and the first results, we fit a MLP with no hidden neurons (a linear model)
...
plot(x,col=col=c('black','green')[(yhat>0.5)+1],pch=19,main='predicted labels',asp=1)
...
####################################################################
## Multilayer Perceptron Example 3: mixture of distributions 2D data
####################################################################
...
## Let's see what we have done: a 2D classification problem ...
...
## Let's plot now the real data generation mechanism
...
## this can take a while but it's worth the wait
par(mfrow=c(2,2))
